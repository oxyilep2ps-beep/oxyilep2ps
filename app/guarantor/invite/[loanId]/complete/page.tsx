  ...
  if (state === 'error') {
    return (
      <section className="mx-auto flex min-h-[70vh] max-w-lg flex-col items-center justify-center px-4 py-16 text-center">
        ...
        <Link href={`/guarantor/invite/${encodeURIComponent(loanId)}`} className="mt-6 text-sm font-semibold text-brand-600">
          Back to invitation
        </Link>
      </section>
    );
...
export default function GuarantorInviteCompletePage() {
  return (

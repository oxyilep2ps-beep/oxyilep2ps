...
function normalizeRow(row: Record<string, unknown>): Profile {
  ...
  return {
    ...
    is_uk_resident: (row.is_uk_resident as string | null) ?? null,
    understands_p2p_risk: (row.understands_p2p_risk as string | null) ?? null,
    marketing_consent: (row.marketing_consent as string | null) ?? null,

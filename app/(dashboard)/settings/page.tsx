  ...
  return (
    <section className="mx-auto max-w-lg px-4 py-8 sm:px-6">
      ...
      <motion.nav
        ...
        className="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-neutral-800 dark:bg-[#111]"
          ...
          {items.map((item, index) => {
            ...
            const rowClass = cn(
              ...
              item.danger
                ...
                : 'text-neutral-900 hover:bg-[#F97316]/5 dark:text-neutral-100 dark:hover:bg-white/5'
            );
              ...
              <>
                <span
                  className={cn(
                    ...
                    item.danger ? 'bg-red-500/10' : 'bg-[#F97316]/10 text-[#F97316]'
                  )}
                >
                  <Icon size={20} />
                </span>

-- =============================================================================
-- Ensure signup metadata lands in public.profiles via auth.users trigger.
-- Fires AFTER INSERT ON auth.users and reads NEW.raw_user_meta_data.
-- Preserves platform_access / admin_allowlist elevated-role grants.
-- =============================================================================
...
begin
  ...
  -- Prefer the structured kyc_data blob from signup; otherwise assemble from flat fields.
...
-- Recreate trigger so it always points at the latest function definition.
...
comment on function public.handle_new_user() is
  'Creates public.profiles from auth.users insert, copying KYC fields from raw_user_meta_data.';

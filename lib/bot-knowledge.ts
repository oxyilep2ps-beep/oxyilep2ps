...
export const BOT_KNOWLEDGE: BotKnowledgeEntry[] = [
  { id: 'k01', keywords: ['what is oxyile', 'about oxyile', 'platform'], answer: 'Oxyile is a UK peer-to-peer lending platform connecting verified investors with approved borrowers, with in-chat handshakes, GoCardless monthly repayments, and Polygon contract records.' },
  { id: 'k02', keywords: ['handshake', 'proposal', 'deal'], answer: 'A handshake is a loan proposal sent inside chat. Both parties must approve before the smart contract mints and GoCardless monthly repayments can activate.' },
  { id: 'k03', keywords: ['approve handshake', 'dual approval'], answer: 'Each party taps Approve on the handshake card. When both approve, the borrower links their bank via GoCardless; then Polygon mint and monthly repayment collection run.' },
  { id: 'k04', keywords: ['emi', 'monthly payment', 'installment', 'repayment'], answer: 'Your monthly repayment is estimated from loan amount, annual rate, and duration. It is shown on the handshake card before you approve.' },
  { id: 'k05', keywords: ['total return', 'total repayment'], answer: 'Total return is the sum of all scheduled monthly repayments over the loan term — principal plus interest, displayed on the handshake card.' },
  ...
  { id: 'k07', keywords: ['gocardless', 'direct debit', 'bank link'], answer: 'Borrowers authorise a UK Direct Debit mandate through GoCardless after both parties approve a handshake. This enables automated monthly repayment collection.' },
  { id: 'k08', keywords: ['mandate', 'authorisation'], answer: 'A GoCardless mandate is your permission for Oxyile to collect monthly repayments from your linked UK bank account on the agreed schedule.' },
  ...
  { id: 'k10', keywords: ['auto-emi', 'subscription', 'recurring'], answer: 'Once the mandate is active, Oxyile creates a GoCardless subscription to auto-deduct the monthly repayment amount each month for the loan duration.' },
  ...
  { id: 'k14', keywords: ['borrower', 'loan', 'borrow'], answer: 'Borrowers receive loan proposals in chat, review monthly repayments and total return, approve, then link a bank account for automated repayments.' },
  ...
  { id: 'k31', keywords: ['paid', 'fiat cleared'], answer: 'Admins mark fiat PAID after GoCardless or treasury confirms funds movement. Repayment schedule then reflects live collections.' },
  ...
  { id: 'k39', keywords: ['oliver', 'bot', 'support'], answer: 'I am Oliver, the in-dashboard assistant. Ask about handshakes, repayment schedules, GoCardless, Polygon, KYC, or account settings.' },
  ...
  { id: 'k49', keywords: ['duration', 'months', 'term'], answer: 'Loan duration is set in months on the handshake proposal and drives monthly repayment and total return calculations.' },
  ...
  { id: 'k67', keywords: ['bank linked', 'checkmark'], answer: 'Bank Linked means your GoCardless mandate is active. Smart Contract Minted confirms on-chain record. Auto-Repayment Active means subscriptions are scheduled.' },
  { id: 'k68', keywords: ['authorisation url', 'redirect'], answer: 'When approving as borrower with both signatures, you are redirected to GoCardless to authorise Direct Debit, then returned to complete mint and repayment setup.' },
  ...
  { id: 'k73', keywords: ['borrower protection'], answer: 'Terms are transparent before approval. You see monthly repayments and total return with no hidden fields on the card.' },
  ...
  { id: 'k76', keywords: ['status pending', 'handshake pending'], answer: 'PENDING handshakes await one or both approvals. No chain mint or repayments until complete.' },
  ...
  { id: 'k84', keywords: ['compound', 'compounding'], answer: 'Repayment estimates use standard monthly amortization on the agreed annual rate for display on the card.' },

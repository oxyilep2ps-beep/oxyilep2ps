...
export function AtsApplicationsPanel({
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-4 dark:border-neutral-800 dark:bg-black">
      <div
        role="tablist"
        aria-label="Application pipeline"
        className="-mx-1 flex gap-1 overflow-x-auto border-b border-gray-200 px-1 pb-px dark:border-neutral-800"
      >
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active ? 'text-[#F97316]' : 'text-neutral-500 hover:text-gray-900 dark:hover:text-neutral-200'
              )}
            >
              {item.label}
              <span
                className={cn(
                  ...
                  active ? 'bg-[#F97316]/20 text-[#F97316]' : 'bg-gray-100 text-neutral-500 dark:bg-neutral-900'
                )}
              >
                {tabCounts[item.id]}
              </span>
      ...
      {visible.length === 0 ? (
        <div className="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-10 text-center dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <ul className="space-y-3">
          {visible.map((row) => {
            ...
            return (
              <li key={row.id} className="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-neutral-800 dark:bg-neutral-950">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div className="min-w-0">
                    <p className="font-bold text-gray-900 dark:text-white">{row.candidate_name}</p>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">{row.candidate_email}</p>
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          active ? meta.className : 'border-gray-200 bg-white text-neutral-500 hover:border-gray-300 dark:border-neutral-800 dark:bg-black dark:hover:border-neutral-600'
                        )}
                      >
                        {meta.label}
                      </button>

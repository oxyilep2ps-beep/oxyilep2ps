  ...
  return (
    <AdminNotificationProvider>
      <div className="relative min-h-[calc(100dvh-4rem)] bg-transparent">
        <header className="sticky top-16 z-30 border-b border-white/60 bg-white/70 backdrop-blur-md dark:border-white/10 dark:bg-[#0B0F19]/80">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className="rounded-full border border-[#F97316]/30 px-3 py-1.5 text-xs font-semibold text-[#F97316] transition hover:bg-[#F97316]/10"
              >
                Dashboard
              </Link>
              <Link

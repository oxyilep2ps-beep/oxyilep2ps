  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-[calc(5.75rem+0.75rem+env(safe-area-inset-bottom))] left-4 z-[9999] inline-flex items-center gap-2 rounded-full border border-emerald-500/40 bg-black px-3 py-2.5 text-xs font-semibold text-emerald-300 shadow-2xl transition hover:border-[#F97316]/50 hover:text-[#F97316] md:bottom-6 lg:left-[17rem]"
